...
class Composer extends StatefulWidget {
  ...
  /// Optional widgets displayed to the right of the text field (before the send button).
...
class _ComposerState extends State<Composer> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasTrailingWidgets = widget.trailingWidgets.isNotEmpty;
    final hasSendButton = widget.sendIcon != null && !widget.sendButtonHidden;
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                if (hasTrailingWidgets || hasSendButton)
                  SizedBox(width: widget.gap),
                if (hasTrailingWidgets) ...[
                  for (var i = 0; i < widget.trailingWidgets.length; i++) ...[
                    widget.trailingWidgets[i],
                    if (i != widget.trailingWidgets.length - 1 || hasSendButton)
                      SizedBox(width: widget.gap),
                  ],
                ],
                if (hasSendButton)

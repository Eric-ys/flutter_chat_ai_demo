...
/// Uses AutomaticKeepAliveClientMixin to preserve widget state when scrolled off-screen,
/// improving scrolling performance by avoiding unnecessary rebuilds.
class _ChatMessageInternalState extends State<ChatMessageInternal>
  ...
  @override
  bool get wantKeepAlive => true; // Keep messages alive when scrolled off-screen for better performance
  ...
  Widget build(BuildContext context) {
    ...
    // Wrap in RepaintBoundary to isolate repaint operations and improve scrolling performance
    return RepaintBoundary(
      child: builders.chatMessageBuilder?.call(
            context,
            _updatedMessage,
            widget.index,
            widget.animation,
